...
ENTRYPOINT ls /run/secrets/elastic-bootstrap-password && echo y | ./elasticsearch/bin/elasticsearch-keystore create && ls /usr/share/logstash/elasticsearch/config \
