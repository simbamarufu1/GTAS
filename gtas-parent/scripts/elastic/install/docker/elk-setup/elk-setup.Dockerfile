...
ENTRYPOINT ls /run/secrets && echo y | ./elasticsearch/bin/elasticsearch-keystore create && ls /usr/share/logstash/elasticsearch/config \
	&& ./elasticsearch/bin/elasticsearch-keystore add bootstrap.password </run/secrets/elastic-bootstrap-password && cat /run/secrets/elastic-bootstrap-password \
